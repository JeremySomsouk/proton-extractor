...
fn test_cli_list_persons() {
    ...
    cmd.arg(ics_path).arg("--list-persons");
...
fn test_cli_list_projects() {
    ...
    cmd.arg(ics_path).arg("--list-projects");
...
fn test_cli_filter_by_person() {
    ...
    cmd.arg(ics_path).arg("--person").arg("Alice");
...
fn test_cli_filter_by_project() {
    ...
    cmd.arg(ics_path).arg("--project").arg("Beta");
...
fn test_cli_exclude_person() {
    ...
    cmd.arg(ics_path).arg("--exclude-person").arg("Alice");
...
fn test_cli_csv_format() {
    ...
    cmd.arg(ics_path).arg("--format").arg("csv");
...
fn test_cli_json_format() {
    ...
    cmd.arg(ics_path).arg("--format").arg("json");
...
fn test_cli_jsonl_format() {
    ...
    cmd.arg(ics_path).arg("--format").arg("jsonl");
...
fn test_cli_list_locations() {
    ...
    cmd.arg(ics_path).arg("--list-locations");
...
fn test_cli_list_categories() {
    ...
    cmd.arg(ics_path).arg("--list-categories");
...
fn test_cli_search() {
    ...
    cmd.arg(ics_path).arg("--search").arg("standup");
...
fn test_cli_exclude_summary() {
    ...
    cmd.arg(ics_path).arg("--exclude-summary").arg("standup");
...
fn test_cli_top_events() {
    ...
    cmd.arg(ics_path).arg("--top").arg("2");
...
fn test_cli_weekdays_filter() {
    ...
    cmd.arg(ics_path).arg("--weekdays").arg("FR");
...
fn test_cli_weekdays_multiple() {
    ...
    cmd.arg(ics_path).arg("--weekdays").arg("MO,WE");
...
fn test_cli_group_by_person() {
    ...
    cmd.arg(ics_path).arg("--group-by-person");
...
fn test_cli_group_by_project() {
    ...
    cmd.arg(ics_path).arg("--group-by-project");
...
fn test_cli_markdown_format() {
    ...
    cmd.arg(ics_path).arg("--format").arg("markdown");
...
fn test_cli_yaml_format() {
    ...
    cmd.arg(ics_path).arg("--format").arg("yaml");
...
fn test_cli_html_format() {
    ...
    cmd.arg(ics_path).arg("--format").arg("html");
...
fn test_cli_ical_format() {
    ...
    cmd.arg(ics_path).arg("--format").arg("ical");
...
fn test_cli_pivot_format() {
    ...
    cmd.arg(ics_path).arg("--format").arg("pivot");
...
fn test_cli_limit() {
    ...
    cmd.arg(ics_path).arg("--limit").arg("2");
...
fn test_cli_min_duration() {
    ...
    cmd.arg(ics_path).arg("--min-duration").arg("1h");
...
fn test_cli_max_duration() {
    ...
    cmd.arg(ics_path).arg("--max-duration").arg("30m");
...
fn test_cli_category_filter() {
    ...
    cmd.arg(ics_path).arg("--category").arg("Meeting");
...
fn test_cli_location_filter() {
    ...
    cmd.arg(ics_path).arg("--location").arg("Office");
...
fn test_cli_recurring_events() {
    ...
    cmd.arg(ics_path).arg("--include-recurring");
...
fn test_cli_exclude_recurring() {
    ...
    cmd.arg(ics_path).arg("--exclude-recurring");
...
fn test_cli_tag_filter() {
    ...
    cmd.arg(ics_path).arg("--tag").arg("Alpha");
...
fn test_cli_persons_filter_or_logic() {
    ...
    cmd.arg(ics_path).arg("--persons").arg("Alice,Bob");
...
fn test_cli_list_tags() {
    ...
    cmd.arg(ics_path).arg("--list-tags");
...
fn test_cli_list_years() {
    ...
    cmd.arg(ics_path).arg("--list-years");
...
fn test_cli_list_uids() {
    ...
    cmd.arg(ics_path).arg("--list-uids");
...
fn test_cli_exclude_category() {
    ...
    cmd.arg(ics_path).arg("--exclude-category").arg("Meeting");
...
fn test_cli_exclude_location() {
    ...
    cmd.arg(ics_path).arg("--exclude-location").arg("Remote");
...
fn test_cli_verbose_flag() {
    ...
    cmd.arg(ics_path).arg("--verbose").arg("--dry-run");
...
fn test_cli_total_only() {
    ...
    cmd.arg(ics_path).arg("--total-only");

    cmd.assert().success().stdout(predicate::str::contains("h"));
}
...
fn test_cli_sort_by_duration() {
    ...
    cmd.arg(ics_path).arg("--sort-by").arg("duration");
...
fn test_cli_sort_by_person() {
    ...
    cmd.arg(ics_path).arg("--sort-by").arg("person");
...
fn test_cli_output_file() {
    ...
    cmd.arg(ics_path).arg("--output").arg(&temp_output);

    cmd.assert().success();

    assert!(temp_output.exists());
    std::fs::read_to_string(&temp_output)
        .unwrap()
        .contains("March");
...
fn test_cli_group_by_weekday() {
    ...
    cmd.arg(ics_path).arg("--group-by-weekday");
...
fn test_cli_group_by_location() {
    ...
    cmd.arg(ics_path).arg("--group-by-location");
...
fn test_cli_group_by_category() {
    ...
    cmd.arg(ics_path).arg("--group-by-category");
...
fn test_cli_group_by_year() {
    ...
    cmd.arg(ics_path).arg("--group-by-year");
...
fn test_cli_year_filter() {
    ...
    cmd.arg(ics_path).arg("--year").arg("2024");
...
fn test_cli_invalid_time_format() {
    ...
    cmd.arg(ics_path).arg("--start-after").arg("invalid");
...
fn test_cli_include_summary() {
    ...
    cmd.arg(ics_path).arg("--include-summary").arg("standup");
...
fn test_cli_exclude_status() {
    ...
    cmd.arg(ics_path).arg("--exclude-status").arg("tentative");
...
fn test_cli_dedupe_by_summary() {
    ...
    cmd.arg(ics_path).arg("--dedupe-by-summary");
...
fn test_cli_bottom_events() {
    ...
    cmd.arg(ics_path).arg("--bottom").arg("3");
...
fn test_cli_week_number_filter() {
    ...
    cmd.arg(ics_path).arg("--week-number").arg("11");
...
fn test_cli_list_events() {
    ...
    cmd.arg(ics_path).arg("--list-events");
...
fn test_cli_exclude_weekdays() {
    ...
    cmd.arg(ics_path).arg("--exclude-weekdays").arg("SA,SU");
...
fn test_cli_invalid_duration_format() {
    ...
    cmd.assert().failure().stderr(predicate::str::contains(
        "invalid duration 'invalid' for --min-duration",
    ));
}
